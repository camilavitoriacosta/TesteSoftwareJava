...
import com.example.testingweb.produto.builders.ProdutoBuilder;
...
public class ProdutoTest {
	...
	public void deve_conter_um_valor_unitario_positivo() throws ValorInvalidoException {
		...
		Produto produto = new ProdutoBuilder().comValorUnitario(valorUnitarioEsperado).construir();

		Assertions.assertEquals(valorUnitarioEsperado, produto.getValorUnitario());
	}

	@Test
	public void deve_conter_uma_descricao() throws ValorInvalidoException {
		String descricaoEsperada = "fogao de 4 bocas";

		Produto produto = new ProdutoBuilder().comDescricao(descricaoEsperada).construir();
